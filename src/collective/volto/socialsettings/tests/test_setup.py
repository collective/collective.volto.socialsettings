...
from collective.volto.socialsettings.testing import COLLECTIVE_VOLTO_SOCIALSETTINGS_INTEGRATION_TESTING  # noqa: E501
...
class TestSetup(unittest.TestCase):
    ...
    layer = COLLECTIVE_VOLTO_SOCIALSETTINGS_INTEGRATION_TESTING
